...
export function CardGridSkeleton({ count = 6 }: { count?: number }) {
  return (
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3" aria-label="Carregando conteúdo">
...
export function TableSkeleton({ count = 8 }: { count?: number }) {
  return (
    <div className="mx-auto w-full max-w-5xl space-y-3" aria-label="Carregando tabela">
